...
- [Live Site Review (LSR)](avito-developer-practice.md#live-site-review-lsr) — разбор инцидентов
- [Архитектурный комитет](avito-developer-practice.md#архитектурный-комитет) — ревью архитектуры приложений и сервисов
- [Team maturity model](avito-developer-practice.md#Team-Maturity-Model) — Модель зрелости: как мы оцениваем и растим инженерные команды
