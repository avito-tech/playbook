...
| **Формализация и решение задачи** <br>ЗАВИСИТ ОТ УРОВНЯ ПРОЕКТА | Самостоятельная формализация, решение и интерпретация junior level задач. | Самостоятельная формализация, решение и интерпретация middle проекта | Самостоятельная формализация, решение и интерпретация senior проекта. | Самостоятельная формализация, решение и интерпретация lead проекта. |
