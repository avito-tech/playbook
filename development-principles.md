...
- [Основные принципы](development-principles.md#основные-принципы)
  - [Мы отвечаем за работоспособность своей системы](development-principles.md#мы-отвечаем-за-работоспособность-своей-системы)
  - [Ваша система – это ответственность надолго](development-principles.md#ваша-система--это-ответственность-надолго)
  - [Мы начинаем реализацию с проектирования и учитываем текущую архитектуру](development-principles.md#мы-начинаем-реализацию-с-проектирования-и-учитываем-текущую-архитектуру)
  - [Мы избегаем ненужной сложности](development-principles.md#мы-избегаем-ненужной-сложности)
  - [Мы используем готовые инструменты и не изобретаем велосипеды](development-principles.md#мы-используем-готовые-инструменты-и-не-изобретаем-велосипеды)
  - [Мы относимся к чужому коду с уважением](development-principles.md#мы-относимся-к-чужому-коду-с-уважением)
  - [Если что-то становится ненужным, мы это удаляем](development-principles.md#если-что-то-становится-ненужным-мы-это-удаляем)
- [Проектирование](development-principles.md#проектирование)
  -  [Мы избегаем жёсткой связанности (coupling)](development-principles.md#мы-избегаем-жёсткой-связанности-coupling)
  -  [Мы не завязываемся на детали реализации](development-principles.md#мы-не-завязываемся-на-детали-реализации)
- [Интерфейсы](development-principles.md#интерфейсы)
  - [Внешний интерфейс важнее внутренней реализации](development-principles.md#внешний-интерфейс-важнее-внутренней-реализации)
  - [Мы соблюдаем обратную совместимость](development-principles.md#мы-соблюдаем-обратную-совместимость)
  - [Мы делаем интерфейсы простыми и удобными для использования](development-principles.md#мы-делаем-интерфейсы-простыми-и-удобными-для-использования)
- [Документация](development-principles.md#документация)
  - [Мы документируем интерфейсы, особенности работы системы, нефункциональные требования — и держим их в актуальном состоянии ](development-principles.md#мы-документируем-интерфейсы-особенности-работы-системы-нефункциональные-требования--и-держим-их-в-актуальном-состоянии)
- [Работа с данными](development-principles.md#работа-с-данными)
  - [Мы не пишем бизнес-логику на стороне базы](development-principles.md#мы-не-пишем-бизнес-логику-на-стороне-базы)
  - [Мы используем шину данных только для уведомления о событиях](development-principles.md#мы-используем-шину-данных-только-для-уведомления-о-событиях)
  - [Мы кэшируем данные там, где это необходимо](development-principles.md#мы-кэшируем-данные-там-где-это-необходимо)
  - [У данных есть только один источник правды](development-principles.md#у-данных-есть-только-один-источник-правды)
  - [Мы не храним данные в stateless-компонентах, а используем персистентные хранилища](development-principles.md#мы-не-храним-данные-в-stateless-компонентах-а-используем-персистентные-хранилища)
  - [Мы соблюдаем обратную совместимость миграций](development-principles.md#мы-соблюдаем-обратную-совместимость-миграций)
- [Взаимодействие сервисов](development-principles.md#взаимодействие-сервисов)
  - [По возможности, мы используем асинхронное взаимодействие](development-principles.md#по-возможности-мы-используем-асинхронное-взаимодействие)
  - [Мы пишем наш код так, чтобы система продолжала работать в случае сбоев (fault tolerance)](development-principles.md#мы-пишем-наш-код-так-чтобы-система-продолжала-работать-в-случае-сбоев-fault-tolerance)
  - [Мы запрашиваем только необходимые данные](development-principles.md#мы-запрашиваем-только-необходимые-данные)
- [Тестирование](development-principles.md#тестирование)
  - [Любые изменения должны легко тестироваться автоматически](development-principles.md#любые-изменения-должны-легко-тестироваться-автоматически)
  - [Что не протестировано – то не работает. Что не работает – не катим](development-principles.md#что-не-протестировано--то-не-работает-что-не-работает--не-катим)
  - [Мы работаем по Zero Bug Policy](development-principles.md#мы-работаем-по-zero-bug-policy)
- [Эксплуатация](development-principles.md#эксплуатация)
  - [Мы всегда в курсе, что происходит с нашими системами](development-principles.md#мы-всегда-в-курсе-что-происходит-с-нашими-системами)
