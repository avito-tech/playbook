...
- [Основные принципы](https://github.com/avito-tech/playbook/new/master#основные-принципы)
  - [Мы отвечаем за работоспособность своей системы](https://github.com/avito-tech/playbook/new/master#мы-отвечаем-за-работоспособность-своей-системы)
  - [Ваша система – это ответственность надолго](https://github.com/avito-tech/playbook/new/master#ваша-система--это-ответственность-надолго)
  - [Мы начинаем реализацию с проектирования и учитываем текущую архитектуру](https://github.com/avito-tech/playbook/new/master#мы-начинаем-реализацию-с-проектирования-и-учитываем-текущую-архитектуру)
  - [Мы избегаем ненужной сложности](https://github.com/avito-tech/playbook/new/master#мы-избегаем-ненужной-сложности)
  - [Мы используем готовые инструменты и не изобретаем велосипеды](https://github.com/avito-tech/playbook/new/master#мы-используем-готовые-инструменты-и-не-изобретаем-велосипеды)
  - [Мы относимся к чужому коду с уважением](https://github.com/avito-tech/playbook/new/master#мы-относимся-к-чужому-коду-с-уважением)
  - [Если что-то становится ненужным, мы это удаляем](https://github.com/avito-tech/playbook/new/master#если-что-то-становится-ненужным-мы-это-удаляем)
- [Проектирование](https://github.com/avito-tech/playbook/new/master#проектирование)
  -  [Мы избегаем жёсткой связанности (coupling)](https://github.com/avito-tech/playbook/new/master#мы-избегаем-жёсткой-связанности-coupling)
  -  [Мы не завязываемся на детали реализации](https://github.com/avito-tech/playbook/new/master#мы-не-завязываемся-на-детали-реализации)
- [Интерфейсы](https://github.com/avito-tech/playbook/new/master#интерфейсы)
  - [Внешний интерфейс важнее внутренней реализации](https://github.com/avito-tech/playbook/new/master#внешний-интерфейс-важнее-внутренней-реализации)
  - [Мы соблюдаем обратную совместимость](https://github.com/avito-tech/playbook/new/master#мы-соблюдаем-обратную-совместимость)
  - [Мы делаем интерфейсы простыми и удобными для использования](https://github.com/avito-tech/playbook/new/master#мы-делаем-интерфейсы-простыми-и-удобными-для-использования)
- [Документация](https://github.com/avito-tech/playbook/new/master#документация)
  - [Мы документируем интерфейсы, особенности работы системы, нефункциональные требования — и держим их в актуальном состоянии ](https://github.com/avito-tech/playbook/new/master#мы-документируем-интерфейсы-особенности-работы-системы-нефункциональные-требования--и-держим-их-в-актуальном-состоянии)
- [Работа с данными](https://github.com/avito-tech/playbook/new/master#работа-с-данными)
  - [Мы не пишем бизнес-логику на стороне базы](https://github.com/avito-tech/playbook/new/master#мы-не-пишем-бизнес-логику-на-стороне-базы)
  - [Мы используем шину данных только для уведомления о событиях](https://github.com/avito-tech/playbook/new/master#мы-используем-шину-данных-только-для-уведомления-о-событиях)
  - [Мы кэшируем данные там, где это необходимо](https://github.com/avito-tech/playbook/new/master#мы-кэшируем-данные-там-где-это-необходимо)
  - [У данных есть только один источник правды](https://github.com/avito-tech/playbook/new/master#у-данных-есть-только-один-источник-правды)
  - [Мы не храним данные в stateless-компонентах, а используем персистентные хранилища](https://github.com/avito-tech/playbook/new/master#мы-не-храним-данные-в-stateless-компонентах-а-используем-персистентные-хранилища)
  - [Мы соблюдаем обратную совместимость миграций](https://github.com/avito-tech/playbook/new/master#мы-соблюдаем-обратную-совместимость-миграций)
- [Взаимодействие сервисов](https://github.com/avito-tech/playbook/new/master#взаимодействие-сервисов)
  - [По возможности, мы используем асинхронное взаимодействие](https://github.com/avito-tech/playbook/new/master#по-возможности-мы-используем-асинхронное-взаимодействие)
  - [Мы пишем наш код так, чтобы система продолжала работать в случае сбоев (fault tolerance)](https://github.com/avito-tech/playbook/new/master#мы-пишем-наш-код-так-чтобы-система-продолжала-работать-в-случае-сбоев-fault-tolerance)
  - [Мы запрашиваем только необходимые данные](https://github.com/avito-tech/playbook/new/master#мы-запрашиваем-только-необходимые-данные)
- [Тестирование](https://github.com/avito-tech/playbook/new/master#тестирование)
  - [Любые изменения должны легко тестироваться автоматически](https://github.com/avito-tech/playbook/new/master#любые-изменения-должны-легко-тестироваться-автоматически)
  - [Что не протестировано – то не работает. Что не работает – не катим](https://github.com/avito-tech/playbook/new/master#что-не-протестировано--то-не-работает-что-не-работает--не-катим)
  - [Мы работаем по Zero Bug Policy](https://github.com/avito-tech/playbook/new/master#мы-работаем-по-zero-bug-policy)
- [Эксплуатация](https://github.com/avito-tech/playbook/new/master#эксплуатация)
  - [Мы всегда в курсе, что происходит с нашими системами](https://github.com/avito-tech/playbook/new/master#мы-всегда-в-курсе-что-происходит-с-нашими-системами)
