...
- Принимает решения об изменении процессов с опирой на факты и данные. Например, следит за метриками Agile Dashboard и результатами Team Maturity Model или принимает решения об эксперементе с процессами на основе данных ретроспектив.
