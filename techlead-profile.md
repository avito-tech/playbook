...
* Каждый технический менеджер оценивается по следующим компетенциям:
	* Управление людьми
...
### Управление командами
- Менеджер для команды состоящей из трёх или больше инженеров. Достигает результата за счёт слаженной работы команды.
...
### Техническая экспертиза
- Техническая экспертиза на уровне [Е5 разработчика](developer-profile.md#e5). Продолжает тратить 25-50% своего времени на работу руками.
...
- Для оценки перформанса менеджеров использует ясные критерии и метрики. Например: метрики перформанса команд, ключевые проекты, развитие людей, well-being, удовлетворенность пользователей.
...
- Занимается развитием своей лидерской команды. Проводит страт сессии, планирует командные обучения, ассесменты 
...
- Масштаб или Сложность:
	- Масштаб: отвечает за большую зону (несколько разнородных кластеров) или бигбет уровня компании
...
- Способен запитчить сложную тему для АЕМ - сформировать повестку, план и реализовать без подключения бизнеса.
