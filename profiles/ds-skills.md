...
- Декомпозирует свои задачи на подзадачи/майлстоуны (сбор данных, чистка данных, генерация фичей, обучение модельки, приёмка оффлайн/онлайн).
...
- Знает и может назвать целевые метрики своих экспериментов.
