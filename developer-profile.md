...
### Ответственность за результат
- Выступает в роли фича-лида для задач с низкой неопределенностью
...
### Ответственность за результат
- Регулярно выступает в роли фича-лида для задач с низкой и средней неопределенностью.
...
### Ответственность за результат
- Регулярно выступает в роли фича-лида для задач с средней и высокой неопределенностью. Отвечает за полную реализацию фичи: декомпозицию, контроль сроков и качества, доставку до пользователей.
